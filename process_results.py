...
def average_of_n_comprehensiveness(paths,total_topics,total_words,intervals,dataset,field="Topic_Change"):
    ...
    create_folders_if_not_exist(f"final_result/comprehensiveness/{dataset}/{paths[0].split('/')[-1]}/")
    with open(f"final_result/comprehensiveness/{dataset}/{paths[0].split('/')[-1]}//final_res.csv","w") as fp:
        fp.write(restring)
...
def average_of_n_sufficiency(paths,total_topics,total_words,intervals,dataset,field="Topic_Change"):
    ...
    create_folders_if_not_exist(f"final_result/sufficiency/{dataset}/{paths[0].split('/')[-2]}/{paths[0].split('/')[-1]}/")
    with open(f"final_result/sufficiency/{dataset}/{paths[0].split('/')[-2]}/{paths[0].split('/')[-1]}/final_res.csv","w") as fp:
        fp.write(restring)
