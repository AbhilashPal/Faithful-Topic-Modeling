...
from src.calculate_sufficiency import dump_sufficiency_results_cumulative
...
def main():
    ...
    dump_sufficiency_results_cumulative(docs,args.k,args.path,use_keybert=args.keybert)
